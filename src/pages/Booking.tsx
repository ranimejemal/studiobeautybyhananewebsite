...
const Booking = () => {
  ...
  const treatments = [
    ...
    { id: 27, name: "Lifting Naturel", description: "Injections ciblées pour lisser les rides et détendre les muscles du visage.", price: 70, duration: "75 min", image: "/Rejuvenate Your Skin with Carbon Laser Treatment at Estatico Facialbar.jpg" },
    { id: 16, name: "Peeling Carbon", description: "Soin au laser avec masque carbone pour resserrer les pores et purifier la peau.", price: 250, duration: "60 min", image: "/botox.jpg" },
